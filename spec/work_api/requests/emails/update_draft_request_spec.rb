...
RSpec.describe(WorkApi::Requests::Emails::UpdateDraftRequest) do
  ...
  let(:body) { WorkApi::EmailBody.new(plain_text: ['This is a plain text body segment (updated)']) }
  let(:to_recipients) { [WorkApi::EmailAddress.new(name: 'Dan', address: 'dan+updatedrequest@livil.co')] }
