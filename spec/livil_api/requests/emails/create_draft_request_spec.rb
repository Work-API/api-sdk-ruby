...
RSpec.describe(LivilApi::Requests::Emails::CreateDraftRequest) do
  ...
  context '#path' do
    ...
    it { is_expected.to eq('email/drafts') }
  end

  context 'client#call' do
    let(:cassette_name) { 'draft_create_success' }
    ...
    context 'with attachments' do
      ...
      context 'direct upload' do
        let(:cassette_name) { 'draft_create_attachment_success' }
